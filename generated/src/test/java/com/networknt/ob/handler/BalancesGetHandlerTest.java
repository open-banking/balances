...
@Ignore
public class BalancesGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(BalancesGetHandlerTest.class);
    ...
    @Test
    public void testBalancesGetHandlerTest() throws ClientException {
